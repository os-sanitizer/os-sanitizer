...
struct Args {
    ...
    #[arg(
        long,
        hide(true),
        help = "Log potential Leaky Vessel issues (added after original evaluation); see: https://www.bleepingcomputer.com/news/security/leaky-vessels-flaws-allow-hackers-to-escape-docker-runc-containers Note: not included in option --all"
    )]
    leaky_vessel: bool,
