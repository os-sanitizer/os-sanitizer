...
# Main table
print("Table 3: Results of standardized benchmarks expressed as ratio over baseline.")
print("Rows: Pass, perlbench, gcc, mcf, omnetpp, xalancbmk, x264, deepsjeng, leela, exchange2, xz, Browser")
for i in range(17):
...
# Additional data
print("Additional Table: Median (m) and standard deviation (σ) of time in seconds for standardized benchmarks.")
print("Rows: Pass, perlbench (m, σ), gcc (m, σ), mcf (m, σ), omnetpp (m, σ), xalancbmk (m, σ), x264 (m, σ)")
for i in range(17):
...
# Additional data
print("Additional Table: Median (m) and standard deviation (σ) of time in seconds for standardized benchmarks.")
print("Rows: Pass, deepsjeng (m, σ), leela (m, σ), exchange2 (m, σ), xz (m, σ), Browser (m, σ)")
for i in range(17):
